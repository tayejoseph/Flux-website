    ...
    <Container>
      ...
      <div className="row">
        ...
        <div className="col">
          ...
          <p>
            With Flux you can instantly receive money from anywhere using
            Bitcoin or USDT. We have the best exchange rates for your cash,
            spend exactly what you receive.
          </p>
          <a href="/" className="link--arrow">
            See how <BiRightArrowAlt />
          </a>
        </div>
      </div>
    </Container>
