  ...
  return (
    <Container>
      <ol className="tabs" role="tablist" aria-label="How to transact">
        <li
          className={`semi-header ${
            activeTab === "receiveMoney" ? "active" : ""
          }`}
          role="tab"
          aria-selected={activeTab === "receiveMoney" ? "true" : "false"}
          tabIndex="0"
          onClick={() => setState("receiveMoney")}
        >
        ...
        <li
          ...
          aria-selected={activeTab !== "receiveMoney" ? "true" : "false"}
          tabIndex="1"
          onClick={() => setState("sendMoney")}
        >
          HOW TO SEND MONEY
        </li>
      </ol>
      <div className="content--header">
        {activeTab === "receiveMoney" ? (
          <p>
            You can receive money from Cashapp, Coinbase, or any other Crypto
            wallet.
          </p>
        ) : (
          <p>
            Send funds on flux in just three simple steps. It really is that
            easy.
          </p>
        )}
        {activeTab === "receiveMoney" && (
      ...
      <div className="row">
        <div className="col">
          ...
          <p className="small--body">
            Navigate to Crypto Wallet, click the options button of which ever
            crypto you want to receive funds from.
          </p>
          <div>
        ...
        <div className="col">
          ...
          <p className="small--body">
            Copy and share the address displayed to you. Transfer funds and
            spend your cash instantly!
          </p>
          <div>
